...
<!-- 友情链接 开始 -->
            ...
            <div class="zykdh_title">
						<font style="border-bottom: 2px solid #0e5298;">友情链接 </font>
					  </div>
              <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
                <tbody>
                  <tr>
                    <td colspan="3" height="2"><img src="index_04.gif" width="750" height="1"></td>
                  </tr>
                  <tr>
                    <td colspan="3"><table border="0" cellpadding="1" cellspacing="1" width="100%">
                        <tbody>
                          <tr>
            ...
            <div class="bottom">
            	  <hr/>
            	主办：镇江市不动产登记交易中心  &nbsp;&nbsp;&nbsp;&nbsp;   备案序号：苏ICP备05002919号 　<br/>
              地址(Add)：镇江市京口区学府路123号 　邮编(Postcode)：212003 　网站电话(Tel): 0511-85890888 <br/>
              业务咨询电话：85890678(市区),80761190(丹阳),80775769(句容1),80775760(句容2),96510(扬中) </div>
            <!-- bottom 结束 -->
          </div>
    </div>
    <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/assets/libs/layui/layui.js"></script>
